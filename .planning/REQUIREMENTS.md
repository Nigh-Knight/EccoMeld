...
- [ ] **INFRA-01**: EccoPath bundled as git submodule with static export packaged as APK assets
...
- [ ] **INFRA-04**: App name displayed as "EccoMeld" (launcher label, app bar)
...
- [ ] **PLAY-01**: Unified playlist auto-plays immediately when bridge is found — no manual "play" action needed
- [ ] **PLAY-02**: Track selection per bridge artist: 2 popular tracks + 3-5 deep cuts, genre-transition order preserved
- [ ] **PLAY-03**: YT Music fuzzy matching resolves each bridge artist's tracks to playable YT Music video IDs
- [ ] **PLAY-04**: YT Music match failures skip silently — unavailable tracks don't break playlist flow
- [ ] **PLAY-05**: Bridge playlist feeds into existing Meld queue and plays via existing player bar
