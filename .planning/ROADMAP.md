...
Plans:
- [ ] 07-01-PLAN.md — BridgeViewModel data layer (seed suggestions, Jaccard random bridge, familiarity resolution, unit tests)
...
| 7. Spotify Integration | 0/3 | Not started | - |
